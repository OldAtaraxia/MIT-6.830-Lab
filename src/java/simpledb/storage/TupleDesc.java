...
public class TupleDesc implements Serializable {
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        if(i < 0 || i >= this.items.toArray().length) {
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        Iterator<TDItem> it = this.items.iterator();
        int i = 0;
        while(it.hasNext()) {
            TDItem item = it.next();
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        Iterator<TDItem> iterator1 = td1.iterator(), iterator2 = td2.iterator();
        int idx = 0;
        while(iterator1.hasNext()) {
            TDItem item = iterator1.next();
            typeAr[idx] = item.fieldType;
            fieldAr[idx++] = item.fieldName;
        }
    ...
    public boolean equals(Object o) {
        ...
        Iterator<TDItem> iterator1 = this.iterator(), iterator2 = other.iterator();
        while(iterator1.hasNext()) {
            TDItem item1 = iterator1.next();
            TDItem item2 = iterator2.next();
    ...
    public String toString() {
        ...
        while (iterator.hasNext()) {
            ...
            ans.append(item.fieldType.toString()).append("(").append(item.fieldName).append(")");
        }
        return ans.toString();
    }
}
